    ...
    grunt.initConfig({
		typescript: {
            ...
            azureangular: {
                ...
                dest: 'dist/angular/cdc-azuremobileservicesForAngular.js',	
                options: {
                    declaration: true,
                    module: 'amd',
                    sourcemap: true,
			...
			azuretableangular: {
                ...
                dest: 'dist/angular/cdc-azureTableStorageServicesForAngular.js',	
                options: {
                    declaration: true,
                    module: 'amd',
                    sourcemap: true,
			...
			azurequeueangular: {
                ...
                dest: 'dist/angular/cdc-azureQueueStorageServicesForAngular.js',	
                options: {
                    declaration: true,
                    module: 'amd',
                    sourcemap: true,
			...
			couchdbangular: {
                ...
                dest: 'dist/angular/cdc-couchDBForAngular.js',	
                options: {
                    declaration: true,
                    module: 'amd',
                    sourcemap: true,
			...
			restfullangular: {
                ...
                dest: 'dist/angular/cdc-restfulDataServiceForAngular.js',	
                options: {
                    declaration: true,
                    module: 'amd',
                    sourcemap: true,
    		...
    		amazonangular: {
                ...
                dest: 'dist/angular/cdc-amazonDataServiceForAngular.js',	
                options: {
                    declaration: true,
                    module: 'amd',
                    sourcemap: true,
			...
			facebook: {
                ...
                dest: 'dist/experimental/cdc-facebook.js',	
                options: {
                    declaration: true,
                    module: 'amd',
                    sourcemap: true,
            ...
            ordrin: {
                ...
                dest: 'dist/experimental/cdc-ordrin.js',	
                options: {
                    declaration: true,
                    module: 'amd',
                    sourcemap: true,
            ...
            twitter: {
                ...
                dest: 'dist/experimental/cdc-twitter.js',
                options: {
                    declaration: true,
                    module: 'amd',
                    sourcemap: true,
		...
		copy: {
			main: {
					...
					dest: 'dist/angular/angularModule.js',
					},
		angular: {
