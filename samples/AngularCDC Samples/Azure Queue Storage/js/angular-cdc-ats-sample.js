var app = angular.module('demoApp', ['ngAnimate', 'AngularCDC', 'AngularCDC.AzureQueueStorageServices', 'ui.bootstrap']);
app.controller('demoController', ['$scope', 'angularCDCService', 'angularCDCAzureQueueStorageServices', '$modal',
    function ($scope, angularCDCService, angularCDCAzureQueueStorageServices, $modal) {
        ...
        $scope.Delete = function (tableName, entity) {
            ...
            angularCDCService._lastSyncDates[angularCDCAzureQueueStorageServices._dataId][tableName] = null;
        ...
        $scope.initialize = function () {
            angularCDCAzureQueueStorageServices.addSource('testmehdi', // accountName
              'RnomjpHwjX1KkD3Ymd+iZFFfftoIU7H3Xy8OmM04tahF4Ra4eXtQAiy/IdEGINqvXxC58QwNlwbJSEH0FBNyuA==',  // secretKey
                 ['people']);      // table name
            angularCDCService.addSource(angularCDCAzureQueueStorageServices);
