var app = angular.module('demoApp', ['ngAnimate', 'CDC', 'AngularCDC.AzureTableStorageServices', 'ui.bootstrap']);
app.controller('demoController', ['$scope', 'CDCService', 'angularCDCAzureTableStorageServices', '$modal',
        ...
        $scope.initialize = function () {
            angularCDCAzureTableStorageServices.addSource('testmehdi', // accountName
              'RnomjpHwjX1KkD3Ymd+iZFFfftoIU7H3Xy8OmM04tahF4Ra4eXtQAiy/IdEGINqvXxC58QwNlwbJSEH0FBNyuA==',  // secretKey
                 ['people']);      // table name
            CDCService.addSource(angularCDCAzureTableStorageServices);
